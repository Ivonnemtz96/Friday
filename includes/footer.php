<footer class="footer-wrapper footer-layout2 bg-dark" data-bg-src="assets/img/bg/bg-fooer-2-1.jpg">
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-12">
                <div class="footer-logo mb-3 mb-xl-5">
            ...
            <div class="col-md-10 col-lg-8 col-xl-6 footer-subscribe mb-3 pb-4">
                ...
                <form action="#" class="footer-subscribe">
                    ...
                    <button type="submit" class="submit-btn">
                        ...
                        <span class="default"><i class="fal fa-envelope"></i></span>
                    </button>
                </form>
            </div>
            <div class="col-12">
                ...
                <p class="text-white fw-medium mb-0">
                    ...
                    <a class="text-white" href="index.html">Haarino</a> - All rights
                    reserved by
                    <a class="text-white" href="https://themeforest.net/user/vecuro_themes">Vecuro</a>.
                </p>
            </div>
        </div>
    </div>
